        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-10 md:gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 font-sans text-xs text-foreground/50">
              <li><Link href="/luxury-watches-in-deira" className="hover:text-primary transition-colors">{t("footer.deira")}</Link></li>
              <li><Link href="/luxury-watches-in-downtown-dubai" className="hover:text-primary transition-colors">{t("footer.downtown")}</Link></li>
              <li><Link href="/luxury-watches-in-jumeirah" className="hover:text-primary transition-colors">{t("footer.jumeirah")}</Link></li>
              <li><Link href="/luxury-watches-in-palm-jumeirah" className="hover:text-primary transition-colors">{t("footer.palm")}</Link></li>
              <li><Link href="/luxury-watches-in-dubai-marina" className="hover:text-primary transition-colors">{t("footer.marina")}</Link></li>
              <li><Link href="/luxury-watches-in-difc" className="hover:text-primary transition-colors">{t("footer.difc")}</Link></li>
              <li><Link href="/luxury-watches-in-business-bay" className="hover:text-primary transition-colors">{t("footer.businessBay")}</Link></li>
              <li><Link href="/luxury-watches-in-jbr" className="hover:text-primary transition-colors">{t("footer.jbr")}</Link></li>
              <li><Link href="/luxury-watches-in-al-barsha" className="hover:text-primary transition-colors">{t("footer.alBarsha")}</Link></li>
              <li><Link href="/luxury-watches-in-bur-dubai" className="hover:text-primary transition-colors">{t("footer.burDubai")}</Link></li>
              <li><Link href="/luxury-watches-in-karama" className="hover:text-primary transition-colors">{t("footer.karama")}</Link></li>
            </ul>
          </div>
          <div>
