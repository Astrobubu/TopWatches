...
export default function ReviewQRPage() {
  return (
    <>
      <style>{`
        @media print {
          header, footer, nav, .scroll-to-top, .no-print { display: none !important; }
      ...
      <div className="min-h-[calc(100vh-5rem)] flex items-center justify-center px-4 py-16">
        <div className="w-full max-w-md text-center space-y-8">
          ...
          <div className="flex justify-center">
            <div
              className="bg-white p-5 inline-block"
          ...
          <div className="flex justify-center gap-1">
            {[...Array(5)].map((_, i) => (
              <svg key={i} viewBox="0 0 24 24" className="w-6 h-6 fill-amber-400 text-amber-400">
