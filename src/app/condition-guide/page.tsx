...
const conditions = [
    ...
    },
    {
        ...
        color: "#60a5fa",
        description: "A previously owned watch in outstanding condition. Shows very minimal signs of wear that are only visible under a jeweler's loupe. The movement has been serviced and certified. Crystal is flawless. Bracelet may have been sized.",
        details: [
    ...
    },
    {
        ...
        color: "#a78bfa",
        description: "A well-maintained pre-owned watch with visible but honest signs of regular wear. Light surface scratches on the case or bracelet that could be polished out. Fully functional movement that has been recently serviced by our certified watchmakers.",
        details: [
